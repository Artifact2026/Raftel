...
#define HDR_NEWVIEW_ACHILLES_CH     0x3D
#define HDR_PREPARE_LDR_ACHILLES_CH 0x3E
#define HDR_PREPARE_ACHILLES_CH     0x3F
...
//     unsigned int id;
//     bool isTEE;
//     bool operator==(const PID &other) const { return id == other.id && isTEE == other.isTEE; }
//     bool operator<(const PID &other) const { return id < other.id || (id == other.id && isTEE < other.isTEE); }
// }; // process ids and types
